...
//out.println("name: "+name+" generation: "+generation+" price: "+price+" author: "+author+" cp :"+cp+" publisher: "+publisher+" page1: "+page1+" isbn :"+isbn);
        ...
        if (rs.next() && rs.getString("Email").equals(email)) {
            ...
            st.executeUpdate("INSERT INTO `users`(`userid`, `password`, `name`, `address`, `Email`, `usertype`, `status`, `Descipline`) values('" + userid + "','" + pw + "','" + name + "','" + address + "','" + email + "','" + usertype + "','" + status + "','" + discipline + "')");
            out.println("User is now registered!");
        }
